    ...
    <div class="rightdiv">
      <div class="profileheads">
        ...
        <p>
          ...
          <br />
          <div id="bottombox">
            <br /><h3 className="h3divs"> <strong>Reviews of Deborah: </strong></h3>
            <br />
            <ul>
              <li>
  ...
  return (
    <div class="rightdiv">
      <div class="profileheads">
        <h3>Favorties</h3>
        <div id="favorites">
        <h3 className="h3divs"><strong>My Ultimate Studios </strong></h3>
        <ul>
          <li>
  ...
  return (
    <div class="rightdiv">
      <div class="profileheads">
        <h3>Reviews</h3>
        <div id = "reviews">
        <h3 className="h3divs"><strong>Deborah's Studio Reviews </strong></h3>
        <ul>
          <li>
            <strong>Penthouse: </strong>
            <br />
          ...
          <li>
            <strong>Penthouse: </strong>
            <br />
            5 Stars: Deborah was a pleasure and left the studio in great shape.
          </li>
          <br />
          <li>
            <strong>Mercury</strong>
